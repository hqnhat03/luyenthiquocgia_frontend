    ...
    try {
      ...
      if (result.success || result.status === "success") {
        ...
        if (result.data) {
          ...
          // Fetch complete profile details for teacher
          try {
            ...
            userObj = {
              ...
              name: `${teacherProfile.first_name || ""} ${teacherProfile.last_name || ""}`.trim() || teacherProfile.email.split("@")[0],
              role: "teacher",
              avatar: teacherProfile.avatar_url || undefined,
            };
          } catch (profileErr) {
            console.error("Error fetching full teacher profile, falling back to basic info:", profileErr);
            userObj = {
              id: 0,
              email: data.email,
      ...
      <div className="flex w-full flex-col justify-center px-6 py-12 md:w-1/2 lg:px-16 xl:px-24">
        <div className="mx-auto flex w-full flex-col justify-center gap-8 sm:w-[420px]">
          <div className="flex flex-col gap-3 text-center md:text-left">
            ...
            <h2 className="text-4xl font-bold tracking-tight">Đăng nhập Giảng viên</h2>
