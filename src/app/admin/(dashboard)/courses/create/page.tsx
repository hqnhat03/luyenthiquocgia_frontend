...
export default function CreateCoursePage() {
    ...
    React.useEffect(() => {
        const fetchSubjects = async () => {
            try {
                const subjectRes = await api.get("/common/subjects")
    ...
    async function onSubmit(data: FormValues) {
        ...
        try {
            ...
            formData.append("title", data.name) // backend requires title too
            if (data.description) {
            ...
            const materials = data.course_materials?.filter(m => m.link_url.trim() !== "") || []
            materials.forEach((m, index) => {
                formData.append(`course_materials[${index}][title]`, "title test")
            ...
            await api.post("/admin/courses/create", formData, {
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card className="border-none shadow-lg bg-card/50 backdrop-blur-sm">
                            <CardHeader>
                                ...
                                <CardDescription>Tạo và quản lý các lịch học cho khóa học này</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
