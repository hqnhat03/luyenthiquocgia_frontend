...
export default function EditArticlePage() {
    ...
    const fetchArticle = React.useCallback(async () => {
        setIsLoading(true)
        try {
            const res = await api.get(`/admin/news/detail?id=${id}`)
            ...
            setIsLoading(true) // Set to false after first render or wait?
                ...
                >
                    {isSubmitting ? (
                        ...
                        <>
                            ...
                            <span className="text-sm font-bold">Lưu thay đổi</span>
                        </>
                    )}
                </Button>
            </div>
        ...
        return (
            <div className="flex flex-col gap-6 p-6 w-full mx-auto animate-in fade-in duration-500">
                <div className="w-full space-y-8">
                    <Skeleton className="aspect-[21/5] w-full rounded-2xl" />
